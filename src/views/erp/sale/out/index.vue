<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="物流状态" prop="logisticsStatus">
        <el-select v-model="queryParams.logisticsStatus" placeholder="请选择物流状态" clearable class="!w-240px">
          <el-option
            v-for="dict in getIntDictOptions(DICT_TYPE.ERP_LOGISTICS_ORDER_STATUS)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column label="物流状态" align="center" prop="logisticsStatus" width="100">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.ERP_LOGISTICS_ORDER_STATUS" :value="scope.row.logisticsStatus" />
        </template>
      </el-table-column>
